...
class SurveyPage4Gain extends StatefulWidget {
  ...
  const SurveyPage4Gain({super.key,required this.kg,required this.lbs,required this.initKg,required this.initLbs,required this.weightType,required this.onChangeKg,required this.onChangeLbs,required this.onChangeType});
  @override
      ...
      child: Column(
        ...
        children: [
         ...
         Visibility(
            ...
            child: WheelPicker(
                looping: false,
                builder: (context, index) => Text("${index+widget.initKg} ${weightList[widget.weightType]['unit']}", style: textStyle),
                controller: kgWheel,
          ...
          Visibility(
            ...
            child:
              WheelPicker(
                looping: false,
                builder: (context, index) => Text("${index+widget.initLbs} ${weightList[widget.weightType]['unit']}", style: textStyle),
